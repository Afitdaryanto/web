...
[[ -f $HOME/.acred/data/upgrade-info.json ]] && cp $HOME/.acred/data/upgrade-info.json $HOME/.acred/cosmovisor/genesis/upgrade-info.json
```
...
<a href="https://www.indonode.net/mainnet/acre/cheat" target="_blank">
