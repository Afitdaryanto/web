...
```
curl -L https://snapshots.indonode.net/realio/realio-snapshot.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.realio-network
[[ -f $HOME/.realio-network/data/upgrade-info.json ]] && cp $HOME/.realio-network/data/upgrade-info.json $HOME/.realio-network/cosmovisor/genesis/upgrade-info.json
```
