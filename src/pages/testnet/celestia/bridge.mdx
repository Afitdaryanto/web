...
Delete old data
```
rm -rf $HOME/.celestia-bridge-blockspacerace-0/data/
rm -rf $HOME/.celestia-bridge-blockspacerace-0/index/
rm -rf $HOME/.celestia-bridge-blockspacerace-0/blocks/
rm -rf $HOME/.celestia-bridge-blockspacerace-0/transients/
```

Restart your node
```
systemctl restart celestia-bridge && journalctl -fu celestia-bridge -o cat
```
