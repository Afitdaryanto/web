...
We are gonna use GO Version 1.20.3
...
```
cel-key add light-wallet --node.type light --p2p.network blockspacerace
```

Recover existing wallet

```
cel-key add light-wallet --node.type light --p2p.network blockspacerace --recover
```
