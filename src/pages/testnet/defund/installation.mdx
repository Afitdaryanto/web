...
```
defundd init <YOUR_MONIKER> --chain-id orbit-alpha-1
```
...
```
curl -Ls https://snapshots.indonode.net/defund-t/genesis.json > $HOME/.defund/config/genesis.json
```
...
```
curl -L https://snapshots.indonode.net/defund-t/defund-snapshot.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.defund
...
<a href="https://www.indonode.net/testnet/defund/cheat" target="_blank">
