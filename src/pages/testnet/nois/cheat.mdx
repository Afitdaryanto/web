...
Unjail Validator
```
noisd tx slashing unjail --from <wallet> --chain-id --chain-id nois-testnet-004 --gas-adjustment 1.4 --gas auto --gas-prices 0unois -y
```
...
```
noisd tx bank send wallet <TO_WALLET_ADDRESS> 1000000unois --from wallet --chain-id nois-testnet-004
```
